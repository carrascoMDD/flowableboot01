...
public class ShippingExchange01AnnouncePayloadTest {
	...
	public void startProcessInstanceByKey_createTaskQuery_getVariables_complete_createHistoricActivityInstanceQuery_createHistoricVariableInstanceQuery()
		...
		this.runtimeService_startProcessInstanceByKey( aHelper,
				"SteelRoll" /* thePayloadKind */,
				12000 /* thePayloadWeight */,
				"Kg" /* thePayloadWeightUnit */,
				2 /* thePayloadVolume */,
	...
	private void runtimeService_startProcessInstanceByKey( FlowableRESTAPIhelper theHelper,
														   String thePayloadKind,
														   Integer thePayloadWeight,
														   String thePayloadWeightUnit,
														   Integer thePayloadVolume,
														   String thePayloadVolumeUnit) throws Exception {

		Map<String, Object> someVariables = new HashMap<String, Object>();
		someVariables.put("var_PayloadKind", thePayloadKind);
		someVariables.put("var_PayloadWeight", thePayloadWeight);
		someVariables.put("var_PayloadWeightUnit", thePayloadWeightUnit);
		someVariables.put("var_PayloadVolume", thePayloadVolume);
		someVariables.put("var_PayloadVolumetUnit", thePayloadVolumeUnit);
